...
import { FaReact, FaNodeJs, FaDocker, FaAws, FaGit, FaJava } from 'react-icons/fa'
import {
  SiRedis,
  SiApachekafka,
  SiTypescript,
...
export const Home = () => {
  ...
  return (
    <Box css={{ px: '$12', '@xsMax': { px: '$10' }, width: '100%' }}>
        ...
        <Box css={{ mb: '$10' }}>
          ...
          <Box as={'ul'} css={{ m: 0 }}>
            ...
            <Box as={'li'} css={{ textIndent: '-3.4em', pl: '3.4em' }}>
              ...
              <Text span>Rust Open Source Developer At ReacherHQ</Text>
            </Box>
          </Box>
        </Box>
      </SectionAnimation>
        ...
        <Box css={{ mb: '$10' }}>
          ...
          <Box as={'ul'} css={{ m: 0 }}>
            <Box as={'li'} css={{ textIndent: '-3.4em', pl: '3.4em' }}>
              ...
              <Text span>Bachelor&apos;s degree in Computer Science from MIT Manipal</Text>
            </Box>
          </Box>
        </Box>
      </SectionAnimation>
      ...
      <SectionAnimation delay={0.3}>
        <Box css={{ mb: '$10' }}>
          ...
          >
            ...
            <SkillItem icon={<TbBrandSocketIo size={20} />} skill="WebSockets" />
      ...
      <br />
      <Text h4>
        I also maintain a list of what I <Link href="/uses">use</Link> and what I am{' '}
